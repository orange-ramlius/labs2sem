...
earth 420 // складываются значения временного объекта и нашего существующего и присваиваются объекту
venus 1000 //временный объект для суммы
moon //удаление временного объекта
moon //удаление локальной копии i2
1429420 //вывод
moon //удаление i1
moon //удаление i2
*/
